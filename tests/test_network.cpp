...
void test_server() {
  ...
  auto *dummy_server0 = new Server(new String("127.0.0.1"), 1234);
  auto *dummy_server1 = new Server(new String("127.0.0.1"), 1234, 30, 200);

  helper.t_false(dummy_server0->running());
...
void test_client() {
  ...
  // client and server
  auto *dummy_client0 = new Client(new String("127.0.0.1"), 1234);
  auto *dummy_client1 = new Client(new String("127.0.0.1"), 1234, 100);

  helper.t_false(dummy_client0->running());
